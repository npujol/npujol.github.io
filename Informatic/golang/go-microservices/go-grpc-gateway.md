...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/golang/go-microservices/grpc-gateway>) \_\_
...
- [
  ...
  ### gRPC-Gateway\_\_ - RESTful API for gRPC Services
  ...
  1. The gateway translates the REST request into a gRPC call to the __StreamingService__.
