...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/golang/go-microservices/go-kit>) \_\_
...
building
microservices
(or elegant monoliths) in Go. it solves common problems in distributed systems and application architecture so you can focus on delivering business value.
...
### Go-Kit\_\_ - Enterprise Microservice Platform
...
1. __PaymentService__ looks up the __AccountService__ when processing payments.
1. All services log events and metrics for monitoring using Go-Kit’s built-in observability tools.
