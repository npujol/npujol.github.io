...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/golang/go-microservices/micro>) \_\_
...
- [
  ...
  ### Micro\_\_ - Distributed System with Service Orchestration
  ...
  1. __DataProcessorService__ scales horizontally based on load, using service discovery to route requests.
  1. __API Gateway__ allows external systems to query processed data.
