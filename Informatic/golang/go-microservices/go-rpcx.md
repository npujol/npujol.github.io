...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/golang/go-microservices/rpcx>) \_\_
...
1. The __PlayerStatsService__ can return the latest statistics in real-time.
