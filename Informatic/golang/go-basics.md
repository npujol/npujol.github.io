...
- \[ [ go-data-types ] \]
  ...
  (<https://roadmap.sh/golang/basics>)
  \_\_
  ...
  Go
  like
  variables, loops, conditional statements, functions, data types, and so on. A good starting point for go basics is its Go’s official docs.
