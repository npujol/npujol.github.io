...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/golang/go-basics/for-loop>) \_\_
...
one
looping
construct, the `for` loop. The basic `for` loop has three components separated by semicolons:
