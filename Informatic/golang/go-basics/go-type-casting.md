...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/golang/go-basics/type-casting>) \_\_
...
automatic
type
conversion, but it allows type casting, which is the process of explicitly changing the variable type.
