...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/golang/go-realtime-communication/centrifugo>) \_\_
...
transports
(WebSocket,
HTTP-streaming, SSE/EventSource, GRPC, SockJS, WebTransport). Centrifugo has the concept of a channel – so it’s a user-facing PUB/SUB server.
...
1. __Real-time Multiplayer Game Server__:
