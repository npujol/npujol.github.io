...
- \[ [ go-twirp ] \]
  ...
  (<https://roadmap.sh/golang/microservices>)
  \_\_
  ...
  - [ articleBuilding Microservices, 2 nd Edition - Sam Newman ] (<https://samnewman.io/books/building_microservices_2nd_edition/>)
  ...
  - [ feedExplore top posts about Microservices ] (<https://app.daily.dev/tags/microservices?ref=roadmapsh>)
    ...
    listed
    Go
    libraries, frameworks, and tools relevant to __microservices__:
