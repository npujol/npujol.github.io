...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/golang/go-advanced/context>) \_\_
...
standardized
way
to handle: Deadlines, Cancellation Signals, etc.
