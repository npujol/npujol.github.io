...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/kubernetes/containers>) \_\_
...
built
on
containers, so before learning Kubernetes you should be comfortable running and building containers from scratch.
