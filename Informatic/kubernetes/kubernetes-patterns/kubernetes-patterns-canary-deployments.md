...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/kubernetes/deployment-patterns/canary-deployments>) \_\_
...
1. __Old Version__: The current production version receiving the bulk of traffic.
1. __New Version (Canary)__: Receives a small portion of traffic to validate the new deployment under real-world conditions.
1. __Load Balancer__: Balances the traffic between old and canary versions.
1. __Monitoring__: Based on the performance of the canary, either a full rollout to the new version or a rollback to the old version occurs.
