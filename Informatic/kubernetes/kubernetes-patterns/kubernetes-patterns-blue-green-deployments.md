...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/kubernetes/deployment-patterns/blue-green-deployments>) \_\_
...
1. __Blue Environment__: Running the current version of the application.
1. __Green Environment__: Holds the new version and is tested thoroughly before switching traffic.
1. __Load Balancer__: Handles the transition from the blue environment to the green environment.
