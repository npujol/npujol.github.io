...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/kubernetes/kubernetes-security/role-based-access-control>) \_\_
...
assigning
roles
to users or groups, access to Kubernetes resources can be restricted or granted based on the permissions defined in the role. RBAC helps ensure the security and integrity of Kubernetes clusters by limiting access to authorized users and groups.
...
1. __Granularity__: Use fine-grained roles over broader permissions to limit access to critical resources.
1. __Role Reviews__: Regularly audit roles and their permissions.
1. __Namespace Segmentation__: Isolate workloads and permissions by using separate namespaces.
1. __RBAC Binding__: Carefully bind roles to users or groups with clear responsibilities.
