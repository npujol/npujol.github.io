...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/kubernetes/kubernetes-introduction/key-concepts-terminologies>) \_\_
...
automates
the
deployment, scaling, and management of containerized applications. Here are some important concepts and terminologies in Kubernetes:
