...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/python/python-advanced-topics/generator-expressions>) \_\_
...
line
of
code in Python. They are similar to list comprehensions, but instead of creating a list, they create a generator object that produces the values on-demand, as they are needed.
