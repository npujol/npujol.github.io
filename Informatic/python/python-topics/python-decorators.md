...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/python/python-advanced-topics/decorators>) \_\_
...
a
design
pattern in Python that allows a user to add new functionality to an existing object without modifying its structure. Decorators are usually called before the definition of a function you want to decorate.
