...
- \[ [ python-frameworks-flask ] \]
  ...
  (<https://roadmap.sh/python/frameworks>)
  \_\_
  ...
  provide
  common
  patterns in a web application that are fast, reliable and easily maintainable. Visit the following resources to learn more:
