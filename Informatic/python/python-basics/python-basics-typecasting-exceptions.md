...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/python/python-basics/typecasting-exceptions>) \_\_
...
type
(integer,
string, float, etc.) to another data type is called type conversion. Python has two types of type conversion: Implicit and Explicit.
