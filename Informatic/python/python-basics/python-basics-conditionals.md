...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/python/python-basics/conditionals>) \_\_

## Conditionals

Conditional
Statements in Python perform different actions depending on whether a specific condition evaluates to true or false. Conditional Statements are handled by IF-ELIF-ELSE statements and MATCH-CASE statements in Python.
