...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/python/python-basics/lists-tuples-sets-dictionaries>) \_\_
...
dynamic
sized
arrays, declared in other languages (vector in C++ and ArrayList in Java). Lists need not be homogeneous always which makes it the most powerful tool in Python.
