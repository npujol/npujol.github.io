...
- \[ [ devops-learn-a-programming-language-javascript-node-js ] \]
  ...
  (<https://roadmap.sh/devops/learn-a-programming-language@qe84v529VbCyydl0BKFk2>)
  \_\_
  ...
  language
  you
  pick, but it is important to learn at least one. You will be able to use that language to write automation scripts.
