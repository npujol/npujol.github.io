...
1. Internet Access: Resources are accessible from anywhere with an internet connection.
1. Resource Pooling: Cloud providers allocate resources from a large pool, allowing cost savings through bulk purchasing. Customers don’t need to know the physical location of resources.
1. Elasticity: Resources are flexible, allowing customers to scale up or down quickly based on their needs.
1. Pay-As-You-Go: Customers only pay for the resources they use or reserve. When usage stops, payments stop.
...
1. Projects: Organize resources.
1. Folders: Group projects for management (e.g., per department).
1. Organization Node: Top-level entity encompassing all projects and resources within an organization.
...
1. Allocation Quotas: Limit the number of resources a project can have (e.g., a project can have up to 5 Virtual Private Cloud networks).
