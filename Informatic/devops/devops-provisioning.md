...
- \[ [ devops-provisioning-terraform ] \]
  ...
  (<https://roadmap.sh/devops/provisioning@V9sOxlNOyRp0Mghl7zudv>)
  \_\_
  ...
  to
  support
  an application or service.This
  includes
  allocating
  and
  preparing
...
1. __Nomad__: HashiCorp’s orchestrator that runs across both Kubernetes and traditional server applications, making it flexible for different workloads.
1. __Pulumi__: Uses programming languages like Python, TypeScript, and Go for infrastructure as code, offering a more intuitive experience for developers familiar with these languages.
