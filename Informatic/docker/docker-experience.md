...
- \[ [ docker-experience-continuous-integration ] \]
  ...
  (<https://roadmap.sh/docker/experience>)
  \_\_
  ...
  for
  deploying
  applications.However, docker is also a great tool for developing applications. There are a few different recommendations that you can adopt to improve your development experience.
