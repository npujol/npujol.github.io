...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/docker/developer-experience/continuous-integration>) \_\_
...
actions
(for example build,
test, etc…) automatically as you push code to your version control system.
