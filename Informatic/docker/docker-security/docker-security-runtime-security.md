...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/docker/container-security/runtime-security>) \_\_
...
they
are
running in production. This is a critical aspect of container security, as threats may arrive or be discovered after your containers have been deployed. Proper runtime security measures help to minimize the damage that can be done if a vulnerability is exploited.
