...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/docker/docker-cli/volumes>) \_\_
...
the
container
itself, making it easy to backup, migrate, and manage your persistent data.
