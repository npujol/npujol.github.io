...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/docker/deploying-containers/docker-swarm>) \_\_
...
the
Docker
Engine, which allows you to create and manage a swarm of Docker nodes, referred to as a *Swarm*.
