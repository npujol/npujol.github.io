...
\_\_Roadmap info from [ roadmap website ] (<https://roadmap.sh/linux/working-with-files/soft-hard-links>) \_\_
...
systems
like
Linux, soft (symbolic) and hard links are simply references to existing files that allow users to create shortcuts and duplication effects within their file system.
