...
__Roadmap info from [ roadmap website ]
(\<<https://roadmap.sh/terraform/output> > syntax@31fa8kBzCEn-uCrTSoPM4)__
...
- [articleTerraform Output Values: Complete Guide & Examples]
