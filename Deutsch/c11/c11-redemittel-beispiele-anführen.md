...
id: c11-redemittel-beispiele-anführen
aliases: [ ]
tags:
\- language
\- deutsch
...
- __Beispiel:__ __Das kann man beispielsweise an__ den steigenden Verkaufszahlen __sehen__.Seit der Einführung des neuen Produkts haben sich die Verkäufe
  verdoppelt.- __Beispiel:__ __Das
  kann
  man
  beispielsweise
  an__
  ...
  deutlich
  effizienter
  geworden.## Dazu möchte ich folgende Beispiele anführen
  ...
  die
  Produktionskosten
  gesenkt, und zweitens konnten wir die Lieferzeiten verkürzen.
```
