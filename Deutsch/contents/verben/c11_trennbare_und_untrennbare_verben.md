...
## __durchhalten__ (to persevere, endure)
...
### durchleben__ (to live through, experience)
...
### durchqueren__ (to cross, traverse)
...
### überlaufen__ (to overflow, to defect)
...
### übersiedeln__ (to move, to relocate)
...
### (sich) überarbeiten__ (to overwork oneself, to revise)
...
### überblicken__ (to overlook, to have an overview)
...
### überdenken__ (to reconsider, to think over)
...
### überfordern__ (to overwhelm, to overstrain)
...
### übergeben__ (to hand over, to transfer)
...
### überrennen__ (to overrun, to storm)
...
### umbauen__ (to rebuild, to renovate)
...
### umkehren__ (to turn around, to reverse)
...
### umladen__ (to reload, to transfer goods)
...
### umsteigen__ (to change trains/buses/flights)
...
### umtauschen__ (to exchange, to swap)
...
### umziehen__ (to move, to relocate)
...
### umkreisen__ (to circle, to orbit)
...
### umschreiben__ (to rewrite, to paraphrase)
...
### umstellen__ (to rearrange, to shift)
...
### unterbringen__ (to accommodate, to house)
...
### unterordnen__ (to subordinate, to prioritize)

__Bedeutung__: Etwas oder jemanden in eine untergeordnete Position bringen oder etwas weniger wichtig machen.
...
### unterschätzen__ (to underestimate)
...
### unterscheiden__ (to differentiate, to distinguish)
...
### widerhallen__ (to reverberate, to echo)
...
### widerspiegeln__ (to reflect, to mirror)
...
### widerfahren__ (to happen to, to befall)
...
### widerlegen__ (to refute, to disprove)

__Bedeutung__: Beweisen, dass eine Behauptung oder Theorie falsch ist.
...
### sich widersetzen__ (to oppose, to resist)
...
### widersprechen__ (to contradict, to disagree)
